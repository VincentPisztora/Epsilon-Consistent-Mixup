...
<img src="{{ '/assets/lambda_eta_schedule.png' | relative_url }}" alt="A brief description of the photo" style="display: block; margin: 0 auto; max-width: 100%; border-radius: 8px;">
