...
<img src="{{ '/assets/2_lambda_eta_schedule.pdf' | relative_url }}" alt="A brief description of the photo" style="display: block; margin: 0 auto; max-width: 100%; border-radius: 8px;">
